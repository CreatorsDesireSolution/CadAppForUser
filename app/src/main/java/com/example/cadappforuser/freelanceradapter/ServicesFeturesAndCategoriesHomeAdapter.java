...
public class ServicesFeturesAndCategoriesHomeAdapter extends RecyclerView.Adapter<ServicesFeturesAndCategoriesHomeAdapter.FeatureViewHolder> {
    ...
    Context context;
    List<com.example.cadappforuser.modelfreelancer.ServicesFeatureAndCategoriesHomeModel> servicesFeatureAndCategoriesHomeModelList;

    public ServicesFeturesAndCategoriesHomeAdapter(Context context, List<com.example.cadappforuser.modelfreelancer.ServicesFeatureAndCategoriesHomeModel> servicesFeatureAndCategoriesHomeModelList) {
    ...
    public void onBindViewHolder(@NonNull FeatureViewHolder holder, int position) {
        ...
        com.example.cadappforuser.modelfreelancer.ServicesFeatureAndCategoriesHomeModel servicesFeatureAndCategoriesHomeModel=servicesFeatureAndCategoriesHomeModelList.get(position);
