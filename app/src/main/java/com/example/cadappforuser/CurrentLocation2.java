...
public class CurrentLocation2 extends AppCompatActivity implements OnMapReadyCallback {
        ...
        task.addOnSuccessListener(new OnSuccessListener<Location>() {
            ...
            public void onSuccess(Location location) {
                if (location != null) {
                    ...
                    Toast.makeText(CurrentLocation2.this, "" + currentLocation.getLatitude() + " " + currentLocation.getLongitude(), Toast.LENGTH_SHORT).show();
                    SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager().findFragmentById(R.id.map);
                    mapFragment.getMapAsync(CurrentLocation2.this);
...
//                    Intent intent = new Intent(CurrentLocation2.this, Act_FreelancerPersonalEditProfile.class);
//
