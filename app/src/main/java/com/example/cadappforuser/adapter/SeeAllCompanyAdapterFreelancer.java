...
public class SeeAllCompanyAdapterFreelancer extends RecyclerView.Adapter<SeeAllCompanyAdapterFreelancer.ViewHolder> {


    Context context;
    List<CompanyDetailsModel> companyDetailsModels;

    public SeeAllCompanyAdapterFreelancer(Context context, List<CompanyDetailsModel> companyDetailsModels) {
    ...
    @NonNull
    @Override
    public SeeAllCompanyAdapterFreelancer.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.companyall, parent, false);
        SeeAllCompanyAdapterFreelancer.ViewHolder viewHolder = new SeeAllCompanyAdapterFreelancer.ViewHolder(view);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(@NonNull SeeAllCompanyAdapterFreelancer.ViewHolder holder, int position) {
