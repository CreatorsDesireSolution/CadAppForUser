...
public class CompanyDetailAdapterForCompany extends RecyclerView.Adapter<CompanyDetailAdapterForCompany.ViewHolder> implements Filterable {
    ...
    public CompanyDetailAdapterForCompany(Context context, List<CompanyDetailsModel> companyDetailsModels, Activity activity, Act_Session act_session) {
    ...
    @NonNull
    @Override
    public CompanyDetailAdapterForCompany.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.company_details,parent,false);
        CompanyDetailAdapterForCompany.ViewHolder viewHolder=new CompanyDetailAdapterForCompany.ViewHolder(view);
        return  viewHolder;    }

    @Override
    public void onBindViewHolder(@NonNull CompanyDetailAdapterForCompany.ViewHolder holder, int position) {
