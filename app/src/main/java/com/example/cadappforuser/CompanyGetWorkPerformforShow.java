...
public class CompanyGetWorkPerformforShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_get_certificatefor_show);
    ...
    private void ApiGetWorkperformed(String ID) {
        ...
        String remainingUrl2 = "http://aoneservice.net.in/salon/get-apis/company_getworkperformed_api.php?" + "id=" + ID;
