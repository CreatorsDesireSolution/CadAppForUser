...
public class CompanyGetCertificateForShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_get_certificate_for_show);
        ...
        Apigetcertificate(freelancer_id);
    }


    private void Apigetcertificate(String ID) {
        ...
        String remainingUrl2 = "http://aoneservice.net.in/salon/get-apis/company_getcertificate_api.php?" + "id=" + ID;
