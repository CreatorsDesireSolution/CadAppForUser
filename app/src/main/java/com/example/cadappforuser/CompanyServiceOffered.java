...
import com.example.cadappforuser.adapter.Companyserviceofferedadapter;
...
public class CompanyServiceOffered extends AppCompatActivity {
    ...
    Companyserviceofferedadapter addServiceAdapater;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_company_service_offered);
                    ...
                    if (!jsonObject.getString("message").equals("Failed")) {
                        ...
                        for (int i = 0; i < companyAddServiceModels.size(); i++) {
                            if (companyAddServiceModels != null) {
                                ...
                                addServiceAdapater = new Companyserviceofferedadapter(CompanyServiceOffered.this, companyAddServiceModels);
                                recyclerView.setHasFixedSize(true);
                                recyclerView.setAdapter(addServiceAdapater);


                            } else {
                                Toast.makeText(CompanyServiceOffered.this, "No Data", Toast.LENGTH_SHORT).show();
                            }
                        }
                    } else {
                        Toast.makeText(CompanyServiceOffered.this, "No Data", Toast.LENGTH_SHORT).show();
