...
import com.example.cadappforuser.adapter.SeeAllFreelancerAdapterFreelancer;
...
public class SeeAllFreelancerFreelancer extends AppCompatActivity {

    RecyclerView recycleAll;
    SeeAllFreelancerAdapterFreelancer seeAllFreelancerAdapter;
                    ...
                    if (!jsonObject.getString("message").equals("Failed")) {
                        ...
                        for (int i = 0; i < freelancerDetailsModels.size(); i++) {
                            if (freelancerDetailsModels != null) {
                                ...
                                seeAllFreelancerAdapter =new SeeAllFreelancerAdapterFreelancer(context,freelancerDetailsModels);
//                                LinearLayoutManager layoutManager1=new LinearLayoutManager(context,LinearLayoutManager.HORIZONTAL,true);
//                                recyclerView.setLayoutManager(layoutManager1);


                                LinearLayoutManager gridLayoutManager = new LinearLayoutManager(SeeAllFreelancerFreelancer.this);
