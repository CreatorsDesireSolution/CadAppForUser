...
import com.example.cadappforuser.adapter.SeeAllCompanyAdapterFreelancer;
...
public class SeeAllCompanyFreelancer extends AppCompatActivity {
  ...
  //  SeeAllFreelancerAdapter seeAllFreelancerAdapter;
    ...
    SeeAllCompanyAdapterFreelancer seeAllCompanyAdapter;
   String lat,lng;
                    ...
                    if (!jsonObject.getString("message").equals("Failed")) {
                        ...
                        for (int i = 0; i < companyDetailsModels.size(); i++) {
                            if (companyDetailsModels != null) {
                                ...
                                seeAllCompanyAdapter =new SeeAllCompanyAdapterFreelancer(context, companyDetailsModels);
//                                LinearLayoutManager layoutManager1=new LinearLayoutManager(context,LinearLayoutManager.HORIZONTAL,true);
//                                recyclerView1.setLayoutManager(layoutManager1);
                                LinearLayoutManager gridLayoutManager = new LinearLayoutManager(SeeAllCompanyFreelancer.this);
