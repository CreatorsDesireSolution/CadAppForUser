...
public class CompanyStaffListAdapter extends RecyclerView.Adapter<CompanyStaffListAdapter.StaffViewholder> {

    Context context;
    List<CompanyStaffListModel> companyStaffListModelList;

    public CompanyStaffListAdapter(Context context, List<CompanyStaffListModel> companyStaffListModelList) {
