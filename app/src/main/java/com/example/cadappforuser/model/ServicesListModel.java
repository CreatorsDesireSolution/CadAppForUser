...
public class ServicesListModel {
    ...
    public ServicesListModel(String image, String price, String sample, String name,String key_id,String fav_status,String providerId,String status,String userimage) {
        this.image = image;
        this.price = price;
        this.sample = sample;
        this.name = name;
