...
import com.example.cadappforuser.model.PreviousBookingDetailsModel;
...
public class PreviousBookingDetail extends AppCompatActivity {
    ...
    ArrayList<PreviousBookingDetailsModel> previousBookingDetailsModels = new ArrayList<>();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_previous_booking_detail);
        ...
        baseRequest.setBaseRequestListner(new RequestReciever() {
            ...
            public void onSuccess(int requestCode, String Json, Object object) {
                try {
                    ...
                    previousBookingDetailsModels = baseRequest.getDataList(jsonArray, PreviousBookingDetailsModel.class);

                    if (previousBookingDetailsModels.size() != 0) {



                        tv_firstname.setText( previousBookingDetailsModels.get(0).getCustomerFname());
                        lastname.setText(previousBookingDetailsModels.get(0).getCustomerLname());
                        address.setText(previousBookingDetailsModels.get(0).getCustomerAddress());
                        service_name.setText(previousBookingDetailsModels.get(0).getServiceName());
                        service_price.setText(previousBookingDetailsModels.get(0).getPrice());
                        totalamount.setText(previousBookingDetailsModels.get(0).getPrice());
                        mobile_number.setText(previousBookingDetailsModels.get(0).getCustomerMobile());
                        bookingdate.setText(previousBookingDetailsModels.get(0).getServiceDate());
                        bookingtime.setText(previousBookingDetailsModels.get(0).getServiceTime());
