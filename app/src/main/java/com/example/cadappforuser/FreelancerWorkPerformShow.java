...
public class FreelancerWorkPerformShow extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_freelancer_work_perform_show);
    ...
    private void ApiGetWorkperformed(String ID) {
        ...
        String remainingUrl2 = "http://aoneservice.net.in/salon/get-apis/freelancer_getworkperformed_api.php?" + "id=" + ID;
