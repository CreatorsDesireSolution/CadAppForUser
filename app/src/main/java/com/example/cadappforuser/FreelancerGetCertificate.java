...
public class FreelancerGetCertificate extends AppCompatActivity {
    ...
    FreelancerGetCertificateAdapter freelancerGetCertificateAdapter;
                    ...
                    if (!jsonObject.getString("message").equals("Failed")) {
                        ...
                        for (int i = 0; i < freelancerGetCertificateModels.size(); i++) {
...

                            {
                                ...
                                freelancerGetCertificateAdapter = new FreelancerGetCertificateAdapter(context,freelancerGetCertificateModels);
                                recyclerView.setHasFixedSize(true);
                                recyclerView.setAdapter(freelancerGetCertificateAdapter);
